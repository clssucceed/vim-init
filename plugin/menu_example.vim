...
function! MenuHelp_Fscope(cmd)
  exec 'GscopeFind ' . a:cmd . ' ' . expand('<cword>')
endfunc
...
call quickui#menu#install("&File", [
			...
			\ [ "LeaderF F&unciton", 'exec "LeaderfFunction!"', 'List current functions in leaderf'],
			\ [ "LeaderF Buf&Tag", 'exec "LeaderfBufTag!"', 'List current tag in leaderf'],
			\ [ "LeaderF Ta&g", 'exec "LeaderfTag"', 'List current tag in leaderf'],
			\ [ "--", ],
			\ [ "J&unk File", 'JunkFile', ''],
			\ ])
...
call quickui#menu#install('&Symbol', [
			...
			\ [ "--", ],
			\ [ "Find &Definition\t(GNU Global)", 'call MenuHelp_Fscope("g")', 'GNU Global search g'],
			\ [ "Find &Symbol\t(GNU Global)", 'call MenuHelp_Fscope("s")', 'GNU Gloal search s'],
			\ [ "Find &Called by\t(GNU Global)", 'call MenuHelp_Fscope("d")', 'GNU Global search d'],
			\ [ "Find C&alling\t(GNU Global)", 'call MenuHelp_Fscope("c")', 'GNU Global search c'],
			\ [ "Find &From Ctags\t(GNU Global)", 'call MenuHelp_Fscope("z")', 'GNU Global search c'],
			\ [ "--", ],
...
let g:context_menu_k = [
			...
			\ [ "--", ],
			\ ["Quickfix First(&^)\t:cfirst", 'cfirst', 'quickfix cursor rewind'],
			\ ["Quickfix Last(&$)\t:clast", 'clast', 'quickfix cursor to the end'],
			\ ["Quickfix Next(&j)\t:cnext", 'cnext', 'cursor next'],
			\ ["Quickfix Previous(&k)\t:cprev", 'cprev', 'quickfix cursor previous'],
			\ [ "--", ],
			\ [ "Goto D&efinition\t(YCM)", 'YcmCompleter GoToDefinitionElseDeclaration'],
			\ [ "Goto &References\t(YCM)", 'YcmCompleter GoToReferences'],
			\ [ "Get D&oc\t(YCM)", 'YcmCompleter GetDoc'],
...
" hotkey
"----------------------------------------------------------------------
nnoremap <leader>k :call quickui#menu#open()<cr>
